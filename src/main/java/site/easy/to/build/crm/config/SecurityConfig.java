...
public class SecurityConfig implements WebMvcConfigurer {
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                ...
                http.authorizeHttpRequests((authorize) -> authorize
                                ...
                                .requestMatchers("/database/info_connection/**").permitAll()
        ...
        public AuthenticationFailureHandler employeeAuthenticationFailureHandler() {
                ...
                return (request, response, exception) -> {
                        log.error("Employee login failed for username='{}' from ip='{}'",
                                        request.getParameter("username"), request.getRemoteAddr(), exception);
        ...
        public AuthenticationFailureHandler customerAuthenticationFailureHandler() {
                ...
                handler.setUseForward(false);
                return (request, response, exception) -> {
                        log.error("Customer login failed for username='{}' from ip='{}'",
                                        request.getParameter("username"), request.getRemoteAddr(), exception);
                        handler.onAuthenticationFailure(request, response, exception);
                };
        }
